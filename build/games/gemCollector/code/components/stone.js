...
var Stone = (_temp = _class = function (_Component) {
  ...
  _createClass(Stone, [{
    ...
    value: function update() {
      var player1 = document.getElementById('character-0-' + this.props.mode).childNodes[0];
      var player2 = document.getElementById('character-1-' + this.props.mode).childNodes[0];
      var gem = document.getElementById('stoneGem-' + this.props.index + '-' + this.props.mode);
