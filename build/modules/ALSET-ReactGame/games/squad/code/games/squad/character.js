    ...
    _createClass(Character, [{
        ...
        value: function loop() {
            if (document.getElementById('pl' + this.props.charId + "-" + this.props.gameId)) {
                ...
                var direction = _squad2.default.direction[this.props.gameId][this.props.charId];
                if (_index2.default.rect2parent(player, parentEl, direction) && _squad2.default.mode == "play") _squad2.default.moveCharacter(this.props.gameId, this.props.charId);
                this.getCollectives();
                if (_squad2.default.mode == "restart") {
                    _squad2.default.restartCharacter(this.props.gameId, this.props.charId);
                }
            }
        }
    }, {
