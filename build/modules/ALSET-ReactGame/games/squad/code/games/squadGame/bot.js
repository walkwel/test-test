...
var Character = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
    ...
    function Character(props) {
        ...
        _this.loop = function () {
            ...
            var direction = _squadGame2.default.direction[_this.props.gameId][_this.props.charId];
            if (_squadGame2.default.mode == "play") {
                if (_index2.default.rect2parent(player, parentEl, direction)) _squadGame2.default.moveCharacter(_this.props.gameId, _this.props.charId);
                var world = {
                    player: _squadGame2.default.position[_this.props.gameId][_this.props.charId],
                    collectives: _squadGame2.default.collectives[_this.props.gameId]
                };
                if (_this.props.showCodeEditor) {
                    try {
                        var setDirection = eval('(function(world){' + _squadGame2.default.func + '}(world))');
                    } catch (err) {
                ...
                if (setDirection) {
                    if (setDirection.left) _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, "left");else if (setDirection.right) _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, "right");else if (setDirection.up) _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, "up");else if (setDirection.down) _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, "down");
                }
            }
            _this.getCollectives();
            if (_squadGame2.default.mode == "restart") {
                _squadGame2.default.restartCharacter(_this.props.gameId, _this.props.charId);
            }
        };
        ...
        value: function getCollectives() {
            ...
            Array.from(collectives).forEach(function (collective) {
                if (_index2.default.rect2Rect(collective, player)) {
                    ...
                    _squadGame2.default.removeCollective(_this2.props.gameId, collectiveId);
                }
            });
        }
    }, {
                ...
                case 'gnome1':
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(_Gnome2.default, {
                            position: _squadGame2.default.position[this.props.gameId][this.props.charId],
                            direction: _squadGame2.default.direction[this.props.gameId][this.props.charId]
                        })
                    );
                case 'gnome2':
                    return _react2.default.createElement(
