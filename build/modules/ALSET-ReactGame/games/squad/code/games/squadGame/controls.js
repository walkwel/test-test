...
var Controls = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
    ...
    _createClass(Controls, [{
        key: 'loop',
        value: function loop() {
            if (_squadGame2.default.time == 0 && _squadGame2.default.mode != "restart" && _squadGame2.default.mode != "pause") {
                _squadGame2.default.mode = "pause";
                if (this.props.onEnd) {
                    var player = _squadGame2.default.score[0] > _squadGame2.default.score[1] ? "player1" : "player2";
        ...
        value: function startCountDown() {
            setInterval(function () {
                if (_squadGame2.default.mode == "play" && _squadGame2.default.time > 0) _squadGame2.default.time--;
            }, 1000);
        }
    }, {
        key: 'pauseResumeGame',
        value: function pauseResumeGame() {
            if (_squadGame2.default.mode == 'pause') {
                _squadGame2.default.mode = 'play';
        ...
        value: function restartGame() {
            ...
            _squadGame2.default.mode = 'restart';
            setTimeout(function () {
                _squadGame2.default.mode = 'play';
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _squadGame2.default.time == 0 && _react2.default.createElement(
                    'div',
                    { style: {
                            position: "absolute",
                            background: "#7eca84",
                    ...
                    _react2.default.createElement(
                        ...
                        _squadGame2.default.score[0] > _squadGame2.default.score[1] ? "Player 1 Win!!!" : "Player 2 Win!!!"
                    ),
                    _react2.default.createElement(
                        'button',
                ...
                _react2.default.createElement(
                    ...
                    _squadGame2.default.mode == "play" ? "Pause" : "Resume"
                )
            );
        }
    }]);
