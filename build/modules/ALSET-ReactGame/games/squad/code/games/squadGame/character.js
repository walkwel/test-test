...
var Character = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
    ...
    function Character(props) {
        ...
        _this.loop = function () {
            ...
            if (_index2.default.rect2parent(player, parentEl, direction) && _squadGame2.default.mode == "play") _squadGame2.default.moveCharacter(_this.props.gameId, _this.props.charId);
        ...
        document.addEventListener("keydown", function (e) {
            if (_squadGame2.default.currentControllable[_this.props.gameId] == _this.props.charId && _squadGame2.default.mode == "play") {
                switch (e.key) {
                    case _this.props.keys.left:
                        _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, 'left');
                        break;
                    case _this.props.keys.right:
                        _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, 'right');
                        break;
                    case _this.props.keys.up:
                        _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, 'up');
                        break;
                    case _this.props.keys.down:
                        _squadGame2.default.changeDirection(_this.props.gameId, _this.props.charId, 'down');
                        break;
                    case _this.props.keys.action:
                        _squadGame2.default.switchPlayer(_this.props.gameId);
                        break;
                    default:
                        break;
                }
