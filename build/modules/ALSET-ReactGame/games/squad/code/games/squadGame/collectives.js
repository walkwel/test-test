...
var Collectives = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
    ...
    function Collectives() {
        ...
        _this.loop = function () {
            _squadGame2.default.generateCollectives(_this.props.gameId, _this.props.min, _this.props.max, _this.props.size);
        };
            ...
            switch (this.props.type) {
                case 'coin':
                    return _react2.default.createElement(
                        'div',
                        null,
                        _squadGame2.default.collectives[this.props.gameId].map(function (collective, index) {
