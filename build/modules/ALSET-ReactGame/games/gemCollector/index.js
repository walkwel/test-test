...
var selectStore = function selectStore(mode) {
  ...
  switch (mode) {
    ...
    case 'bot-vs-player':
      {
        store = _gameStore4.default;
        break;
      }
    case 'bot-vs-bot':
      {
        store = _gameStore6.default;
        break;
      }
    case 'bot-vs-custom-code':
      {
        store = _gameStore8.default;
        break;
      }
    default:
      {
...
var PlayGemCollectorGame = function (_Component) {
  ...
  function PlayGemCollectorGame() {
    _classCallCheck(this, PlayGemCollectorGame);

    var _this = _possibleConstructorReturn(this, (PlayGemCollectorGame.__proto__ || Object.getPrototypeOf(PlayGemCollectorGame)).call(this));

    _this.initGemCollector = function (mode) {
      var _this$props = _this.props,
          classes = _this$props.classes,
          selectedGameMode = _this$props.selectedGameMode,
          selectedGameConfig = _this$props.selectedGameConfig;
      var _this$state = _this.state,
          updatedCode = _this$state.updatedCode,
        ...
        case 'bot-vs-player':
          {
            return _react2.default.createElement(_code2.default, {
              ...
              onGameEvent: _this.handleGameEvents,
              player2: function player2(world) {
        ...
        case 'bot-vs-bot':
          {
            return _react2.default.createElement(_code2.default, {
              ...
              onGameEvent: _this.handleGameEvents,
              player1: function player1(world) {
    ...
    _this.initFunctionEditor = function () {
      ...
      var _this$state2 = _this.state,
          updatedCode = _this$state2.updatedCode,
          timestamp = _this$state2.timestamp,
          timing = _this$state2.timing,
          showMode = _this$state2.showMode,
          scores = _this$state2.scores,
          showScore = _this$state2.showScore,
          winner = _this$state2.winner,
          playGame = _this$state2.playGame;
  ...
  _createClass(PlayGemCollectorGame, [{
    ...
    value: function getCommands(world, playerNum) {
      ...
      if (closestGem) {
        ...
        if (newState == 11) var direction = { left: false, right: true, up: false, down: false };else if (newState == 10) var direction = { left: false, right: false, up: false, down: true };else if (newState == 9) var direction = { left: true, right: false, up: false, down: false };else if (newState == 8) var direction = { left: false, right: false, up: true, down: false };
        return direction;
      }
    }
  }, {
    ...
    value: function render() {
      var _props = this.props,
          ...
          mode = _props.mode,
          selectedGameConfig = _props.selectedGameConfig,
          showCodeEditor = _props.showCodeEditor;
      var _state = this.state,
          updatedCode = _state.updatedCode,
          timestamp = _state.timestamp,
          timing = _state.timing,
          showMode = _state.showMode,
          scores = _state.scores,
          showScore = _state.showScore,
          winner = _state.winner,
          playGame = _state.playGame;
