...
var Character = (_temp = _class = function (_Component) {
  ...
  _createClass(Character, [{
    ...
    value: function moveRight() {
      ...
      if (this.props.store.checkIfObjectInsideTheScreen(this.props.index, 'right', this.props.gameId)) _matterJs2.default.Body.setVelocity(this.body1.body, {
    ...
    value: function moveLeft() {
      var position = this.props.store.characterPosition[this.props.index];
      if (this.props.store.checkIfObjectInsideTheScreen(this.props.index, 'left', this.props.gameId)) _matterJs2.default.Body.setVelocity(this.body1.body, {
        x: -this.props.store.config.speed,
        y: 0
      });else _matterJs2.default.Body.setVelocity(this.body1.body, { x: 0, y: 0 });
      this.props.store.characterPosition[this.props.index] = this.body1.body.position;
    ...
    value: function moveUp() {
      var position = this.props.store.characterPosition[this.props.index];
      if (this.props.store.checkIfObjectInsideTheScreen(this.props.index, 'top', this.props.gameId)) _matterJs2.default.Body.setVelocity(this.body1.body, {
        x: 0,
    ...
    value: function moveDown() {
      var position = this.props.store.characterPosition[this.props.index];
      if (this.props.store.checkIfObjectInsideTheScreen(this.props.index, 'bottom', this.props.gameId)) _matterJs2.default.Body.setVelocity(this.body1.body, {
        x: 0,
        y: this.props.store.config.speed
      });else _matterJs2.default.Body.setVelocity(this.body1.body, { x: 0, y: 0 });
      this.props.store.characterPosition[this.props.index] = this.body1.body.position;
